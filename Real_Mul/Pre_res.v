module pre_res #(
    ...
    output wire is_special_case           // 1, если один из случаев (NaN/inf/0/inf*0) сработал
);
    ...
    assign is_special_case = result_is_nan | invalid_operation | result_is_zero | result_is_clear_inf;
endmodule
